...
import com.example.springintroex.models.entities.*;
...
public class BookServiceImpl implements BookService {
    ...
    public List<String> findAllBooksByAuthorFirstAndLastNameOrderByReleaseDate(String firstName, String lastName) {
        return bookRepository.findAllByAuthor_FirstNameAndAuthor_LastNameOOrderByReleaseDateDescTitle(firstName, lastName)
                .stream()
